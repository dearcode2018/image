 ...
 * ImageRotateTest
 */
public final class ImageRotateTest extends BaseTest {
	...
	public void testImageRotate() {
		try {
			...
			graphics2d.dispose();
			String outputPath = ProjectUtil.getAbsolutePath("/doc/roate.jpg", true);
			ImageIO.write(resultImage, "JPG", new File(outputPath));
		} catch (Exception e) {
			log.error("testImageRotate =====> ", e);
		}
	}
